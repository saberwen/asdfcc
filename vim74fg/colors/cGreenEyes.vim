...
let g:colors_name="cGreenEyes"
	...
	hi  Comment       cterm=NONE       ctermfg=069             ctermbg=194          guibg=#D7FFD7     guifg=#5F87FF
	hi  CursorLine    cterm=NONE       ctermfg=NONE            ctermbg=159          guibg=#AFFFFF     guifg=NONE
...
"----------------------------------------------------------------------------------
	...
	hi  CursorLineNr  cterm=NONE       ctermfg=172             ctermbg=194          guibg=#D7FFD7     guifg=#D78700
	...
	hi  String        cterm=BOLD       ctermfg=175             ctermbg=194          guibg=#D7FFD7     guifg=#D787AF
	hi  Number        cterm=NONE       ctermfg=160             ctermbg=194          guibg=#D7FFD7     guifg=#D70000
	hi  Float         cterm=NONE       ctermfg=160             ctermbg=194          guibg=#D7FFD7     guifg=#D70000
	hi  Character     cterm=NONE       ctermfg=200             ctermbg=194          guibg=#D7FFD7     guifg=#FF00D7
	hi  Special       cterm=NONE       ctermfg=202             ctermbg=194          guibg=#D7FFD7     guifg=#FF5F00


"----------------------------------------------------------------------------------
" return break hi 
"----------------------------------------------------------------------------------
	hi  Statement     cterm=BOLD       ctermfg=130             ctermbg=194          guibg=#D7FFD7     guifg=#AF5F00

	hi  Conditional   cterm=BOLD       ctermfg=160             ctermbg=194          guibg=#D7FFD7     guifg=#D70000
	hi  Repeat        cterm=BOLD       ctermfg=160             ctermbg=194          guibg=#D7FFD7     guifg=#D70000

	hi  Label         cterm=BOLD       ctermfg=209             ctermbg=194          guibg=#D7FFD7     guifg=#FF875F
	hi  Keyword       cterm=BOLD       ctermfg=160             ctermbg=194          guibg=#D7FFD7     guifg=#D70000
	hi  Include       cterm=NONE       ctermfg=215             ctermbg=194          guibg=#D7FFD7     guifg=#FFAF5F
	hi  Define        cterm=BOLD       ctermfg=150             ctermbg=Blue          guibg=Blue     guifg=#AFD787

	hi  PreProc       cterm=BOLD       ctermfg=130             ctermbg=194          guibg=#D7FFD7     guifg=#AF5F00


"----------------------------------------------------------------------------------
" #define 
"----------------------------------------------------------------------------------
	hi  Macro         cterm=BOLD       ctermfg=093             ctermbg=194          guibg=#D7FFD7     guifg=#8700FF
	
"----------------------------------------------------------------------------------
" static register volatitle 
"----------------------------------------------------------------------------------
	hi  StorageClass  cterm=BOLD       ctermfg=215             ctermbg=194          guibg=#D7FFD7     guifg=#FFAF5F

"----------------------------------------------------------------------------------
" struct union enum 
"----------------------------------------------------------------------------------
	hi  Structure     cterm=BOLD       ctermfg=166             ctermbg=194          guibg=#D7FFD7     guifg=#D75F00

"----------------------------------------------------------------------------------
" Typedef 
"----------------------------------------------------------------------------------
	hi  Typedef       cterm=BOLD       ctermfg=136             ctermbg=194          guibg=#D7FFD7     guifg=#AF8700

"----------------------------------------------------------------------------------
" Type int char 
"----------------------------------------------------------------------------------
	hi  Type          cterm=BOLD       ctermfg=140             ctermbg=194          guibg=#D7FFD7     guifg=#AF87D7

"----------------------------------------------------------------------------------
" Special %s \n %d  
"----------------------------------------------------------------------------------
	hi  SpecialChar   cterm=NONE       ctermfg=199             ctermbg=194          guibg=#D7FFD7     guifg=#FF00AF
...
" Special things inside a comment  
"----------------------------------------------------------------------------------
	hi  Delimiter     cterm=NONE       ctermfg=160             ctermbg=194          guibg=#D7FFD7     guifg=#D70000
...
"----------------------------------------------------------------------------------
	...
	hi  Operator      cterm=NONE       ctermfg=170             ctermbg=194          guibg=#D7FFD7     guifg=#D75FD7

"----------------------------------------------------------------------------------
	hi  Constant     cterm=BOLD       ctermfg=174              ctermbg=194          guibg=#D7FFD7     guifg=#D78787
	hi  Directory    cterm=NONE       ctermfg=160              ctermbg=194          guibg=#D7FFD7     guifg=#D70000
	...
	hi  FoldColumn   cterm=NONE       ctermfg=034              ctermbg=252          guibg=#D0D0D0     guifg=#00AF00
	hi  Folded       cterm=NONE       ctermfg=034              ctermbg=252          guibg=#D0D0D0     guifg=#00AF00
    hi  Title        cterm=NONE       ctermfg=166              ctermbg=194          guibg=#D7FFD7     guifg=#D75F00
"----------------------------------------------------------------------------------
" Makefile 变量 printf memcpy 全局变量 
"----------------------------------------------------------------------------------
	hi  Identifier   cterm=bold       ctermfg=034              ctermbg=194          guibg=#D7FFD7     guifg=#00AF00
"----------------------------------------------------------------------------------
" Makefile 目标
"----------------------------------------------------------------------------------
	hi  Function     cterm=NONE       ctermfg=219              ctermbg=194          guibg=#D7FFD7     guifg=#FFAFFF
"----------------------------------------------------------------------------------
" Makefile ifeq else endif 
"----------------------------------------------------------------------------------
	hi  PreCondit    cterm=bold       ctermfg=160              ctermbg=194          guibg=#D7FFD7     guifg=#D70000
	...
	hi  MoreMsg      cterm=NONE       ctermfg=216              ctermbg=194          guibg=#D7FFD7     guifg=#FFAF87
	hi  ModeMsg      cterm=NONE       ctermfg=196              ctermbg=194          guibg=#D7FFD7     guifg=#FF0000

if (!has("gui_running"))
	hi  StatusLine   cterm=NONE       ctermfg=196              ctermbg=157          guibg=#AFFFAF     guifg=#FF0000
	hi  StatusLineNC cterm=NONE       ctermfg=243              ctermbg=157          guibg=#AFFFAF     guifg=#767676
else
	hi  StatusLine   cterm=NONE       ctermfg=157              ctermbg=196          guibg=#FF0000     guifg=#AFFFAF
	hi  StatusLineNC cterm=NONE       ctermfg=157              ctermbg=157          guibg=#AFFFAF     guifg=#AFFFAF
endif
...
"----------------------------------------------------------------------------------
" Tab line
	hi TabLine       cterm=NONE       ctermfg=021              ctermbg=250          guibg=#BCBCBC     guifg=#0000FF
	hi TabLineSel    cterm=NONE       ctermfg=202              ctermbg=230          guibg=#FFFFD7     guifg=#FF5F00
	hi TabLineFill   cterm=NONE       ctermfg=154              ctermbg=250          guibg=#BCBCBC     guifg=#AFFF00
"----------------------------------------------------------------------------------

"----------------------------------------------------------------------------------
" no use area
"----------------------------------------------------------------------------------
	hi  PmenuSel     cterm=NONE       ctermfg=099              ctermbg=192          guibg=#D7FF87     guifg=#875FFF
	hi  Pmenu        cterm=NONE       ctermfg=099              ctermbg=230          guibg=#FFFFD7     guifg=#875FFF
...
if (g:vimrc_iswindows!=1)
	source ~/.vim/syntax/c/c_new.vim
else
	source ~\vimfiles\syntax\c\c_new.vim
endif
"{{{ color value ---------------------------------------------------------------
